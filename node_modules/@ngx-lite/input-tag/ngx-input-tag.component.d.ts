...
export declare class NgxInputTagComponent implements ControlValueAccessor {
    ...
    static ɵfac: i0.ɵɵFactoryDef<NgxInputTagComponent, never>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<NgxInputTagComponent, "ngx-input-tag", never, { "tagSuggestions": "tagSuggestions"; "maxTagLength": "maxTagLength"; "maxNumberOfTags": "maxNumberOfTags"; }, { "textChange": "textChange"; }, never, never>;
}
export declare function formatter(tag: string): string;
//# sourceMappingURL=ngx-input-tag.component.d.ts.map